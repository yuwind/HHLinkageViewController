...
- (void)readyDeploy:(NSInteger)source relative:(NSInteger)relative view:(UIView *)view equalTo:(CGFloat)constant
{
    switch (source) {
        ...
        case NSLayoutAttributeCenterX:
        {
            ...
            self.hh_centerXCS = [NSLayoutConstraint constraintWithItem:self attribute:NSLayoutAttributeCenterX relatedBy:(NSLayoutRelationEqual) toItem:view?:self.superview attribute:relative multiplier:1.0 constant:constant];
        ...
        case NSLayoutAttributeCenterY:
        {
            ...
            self.hh_centerYCS = [NSLayoutConstraint constraintWithItem:self attribute:NSLayoutAttributeCenterY relatedBy:(NSLayoutRelationEqual) toItem:view?:self.superview attribute:relative multiplier:1.0 constant:constant];
